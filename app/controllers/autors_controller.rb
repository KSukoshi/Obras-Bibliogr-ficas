class AutorsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @autor.save
        format.html { redirect_to @autor, notice: 'Autor foi criado com sucesso.' }
  ...
  def update
    respond_to do |format|
      if @autor.update(autor_params)
        format.html { redirect_to @autor, notice: 'Autor foi atualizado com sucesso.' }
  ...
  def destroy
    @autor.destroy
    respond_to do |format|
      format.html { redirect_to autors_url, notice: 'Autor foi deletado com sucesso.' }
